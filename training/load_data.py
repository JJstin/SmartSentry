# For now not used.Useful when there's need to combine local with online dataset
...
balanced_dataset = load_dataset("imagefolder", data_dir="datasets/processed", drop_labels=False)

# Verify the balanced dataset
print(balanced_dataset)
print(balanced_dataset['train'].features)
