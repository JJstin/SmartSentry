...
HD_PWD='D:/design_project-code/SmartSentry2/camera_fw/vivado/camera_hw/camera_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_design_wrapper.tcl
