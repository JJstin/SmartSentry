...
HD_PWD='C:/Users/georg/Documents/UWaterloo/4A/FYDP/camera_repo/SmartSentry/camera_fw/vivado/camera_hw/camera_hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_design_wrapper.tcl -notrace
