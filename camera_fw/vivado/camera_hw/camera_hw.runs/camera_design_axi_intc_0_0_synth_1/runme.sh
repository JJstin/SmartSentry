...
HD_PWD='C:/Users/georg/vitis/SmartSentry/camera_fw/vivado/camera_hw/camera_hw.runs/camera_design_axi_intc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_design_axi_intc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_design_axi_intc_0_0.tcl
