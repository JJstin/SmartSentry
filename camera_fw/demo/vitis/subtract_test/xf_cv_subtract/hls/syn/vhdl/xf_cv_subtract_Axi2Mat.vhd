...
entity xf_cv_subtract_Axi2Mat is
port (
...
architecture behav of xf_cv_subtract_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal Axi2AxiStream_U0_m_axi_gmem0_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem0_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal AxiStream2Mat_U0_imgInput1_data_din : STD_LOGIC_VECTOR (23 downto 0);
    signal AxiStream2Mat_U0_imgInput1_data_write : STD_LOGIC;
    ...
    component xf_cv_subtract_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component xf_cv_subtract_AxiStream2Mat IS
    port (
    ...
    component xf_cv_subtract_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component xf_cv_subtract_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2AxiStream_U0 : component xf_cv_subtract_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2Mat_U0 : component xf_cv_subtract_AxiStream2Mat
    port map (
    ...
    ldata_U : component xf_cv_subtract_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    start_for_AxiStream2Mat_U0_U : component xf_cv_subtract_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ready <= Axi2AxiStream_U0_ap_ready;
    imgInput2_data_din <= AxiStream2Mat_U0_imgInput1_data_din;
    imgInput2_data_write <= AxiStream2Mat_U0_imgInput1_data_write;
    m_axi_gmem1_ARADDR <= Axi2AxiStream_U0_m_axi_gmem0_ARADDR;
    m_axi_gmem1_ARBURST <= Axi2AxiStream_U0_m_axi_gmem0_ARBURST;
    m_axi_gmem1_ARCACHE <= Axi2AxiStream_U0_m_axi_gmem0_ARCACHE;
    m_axi_gmem1_ARID <= Axi2AxiStream_U0_m_axi_gmem0_ARID;
    m_axi_gmem1_ARLEN <= Axi2AxiStream_U0_m_axi_gmem0_ARLEN;
    m_axi_gmem1_ARLOCK <= Axi2AxiStream_U0_m_axi_gmem0_ARLOCK;
    m_axi_gmem1_ARPROT <= Axi2AxiStream_U0_m_axi_gmem0_ARPROT;
    m_axi_gmem1_ARQOS <= Axi2AxiStream_U0_m_axi_gmem0_ARQOS;
    m_axi_gmem1_ARREGION <= Axi2AxiStream_U0_m_axi_gmem0_ARREGION;
    m_axi_gmem1_ARSIZE <= Axi2AxiStream_U0_m_axi_gmem0_ARSIZE;
    m_axi_gmem1_ARUSER <= Axi2AxiStream_U0_m_axi_gmem0_ARUSER;
    m_axi_gmem1_ARVALID <= Axi2AxiStream_U0_m_axi_gmem0_ARVALID;
    ...
    m_axi_gmem1_RREADY <= Axi2AxiStream_U0_m_axi_gmem0_RREADY;
