...
entity xf_cv_subtract_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of xf_cv_subtract_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 is 
    ...
    constant ap_const_lv21_17BB00 : STD_LOGIC_VECTOR (20 downto 0) := "101111011101100000000";
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1021_fu_84_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal indvar_fu_50 : STD_LOGIC_VECTOR (20 downto 0) := "000000000000000000000";
    signal add_ln1021_fu_90_p2 : STD_LOGIC_VECTOR (20 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_indvar_load : STD_LOGIC_VECTOR (20 downto 0);
...
begin
    ...
    indvar_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1021_fu_84_p2 = ap_const_lv1_0))) then 
                    indvar_fu_50 <= add_ln1021_fu_90_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_fu_50 <= ap_const_lv21_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                gmem0_addr_read_reg_123 <= m_axi_gmem0_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln1021_fu_90_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_load) + unsigned(ap_const_lv21_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1021_fu_84_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1021_fu_84_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_indvar_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, indvar_fu_50, ap_loop_init)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_sig_allocacmp_indvar_load <= ap_const_lv21_0;
        else 
            ap_sig_allocacmp_indvar_load <= indvar_fu_50;
        end if; 
    end process;
    ...
    icmp_ln1021_fu_84_p2 <= "1" when (ap_sig_allocacmp_indvar_load = ap_const_lv21_17BB00) else "0";
    ...
    ldata_din <= gmem0_addr_read_reg_123;
    ldata_write <= ldata_write_local;

    ldata_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
