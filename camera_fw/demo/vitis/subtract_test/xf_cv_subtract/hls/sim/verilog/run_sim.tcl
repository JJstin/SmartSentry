...
if {[file isfile xf_cv_subtract.autotvin.dat]} {
	file delete -force xf_cv_subtract.autotvin.dat
}

if {[file isfile xf_cv_subtract.autotvout.dat]} {
	file delete -force xf_cv_subtract.autotvout.dat
}
