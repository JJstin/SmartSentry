...
IFLAG += -DNT
LFLAG += -L D:/OpenCV/install/x64/mingw/lib -lopencv_imgcodecs440 -lopencv_imgproc440 -lopencv_calib3d440 -lopencv_core440 -lopencv_highgui440 -lopencv_flann440 -lopencv_features2d440 -Wl,--stack,0x40000000
LFLAG += -lpthread
...
$(ObjDir)/main.cpp_pre.cpp.tb.o : main.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	...
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/xf_cv_subtract.cpp_pre.cpp.tb.o : xf_cv_subtract.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling xf_cv_subtract.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -std=c++14 $(IFLAG) $(DFLAG) $< -o $@; \
