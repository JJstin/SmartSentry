...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "xf_cv_subtract.autotvin.dat"
	set constFileTvOut       "xf_cv_subtract.autotvout.dat"
	set constFileHdlTvIn     "xf_cv_subtract.autohdltvin.dat"
	set constFileHdlTvOut    "xf_cv_subtract.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
