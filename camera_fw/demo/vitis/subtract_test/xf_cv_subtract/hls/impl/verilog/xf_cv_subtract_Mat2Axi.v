...
wire   [31:0] Mat2AxiStream_U0_ldata_din;
...
wire   [0:0] start_for_AxiStream2Axi_U0_din;
wire    start_for_AxiStream2Axi_U0_full_n;
wire   [0:0] start_for_AxiStream2Axi_U0_dout;
wire    start_for_AxiStream2Axi_U0_empty_n;
wire    ap_ce_reg;
...
xf_cv_subtract_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
xf_cv_subtract_Mat2AxiStream Mat2AxiStream_U0(
...
xf_cv_subtract_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
xf_cv_subtract_fifo_w64_d3_S dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
xf_cv_subtract_fifo_w32_d2_S_x ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
xf_cv_subtract_start_for_AxiStream2Axi_U0 start_for_AxiStream2Axi_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign AxiStream2Axi_U0_ap_start = start_for_AxiStream2Axi_U0_empty_n;
...
assign ap_idle = (entry_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_entry_proc_U0_ap_ready & ap_sync_Mat2AxiStream_U0_ap_ready);
...
assign start_for_AxiStream2Axi_U0_din = 1'b1;

endmodule //xf_cv_subtract_Mat2Axi
