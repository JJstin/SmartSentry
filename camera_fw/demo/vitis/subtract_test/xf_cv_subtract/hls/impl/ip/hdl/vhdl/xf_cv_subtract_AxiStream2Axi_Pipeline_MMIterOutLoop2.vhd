...
entity xf_cv_subtract_AxiStream2Axi_Pipeline_MMIterOutLoop2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of xf_cv_subtract_AxiStream2Axi_Pipeline_MMIterOutLoop2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1379_fu_88_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ldata_read_reg_127 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_fu_52 : STD_LOGIC_VECTOR (20 downto 0) := "000000000000000000000";
    signal add_ln1379_fu_94_p2 : STD_LOGIC_VECTOR (20 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln1379_fu_88_p2 = ap_const_lv1_0))) then 
                    i_fu_52 <= add_ln1379_fu_94_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_fu_52 <= ap_const_lv21_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln1379_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_5) + unsigned(ap_const_lv21_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln1379_fu_88_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln1379_fu_88_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    icmp_ln1379_fu_88_p2 <= "1" when (ap_sig_allocacmp_i_5 = ap_const_lv21_17BB00) else "0";
    ...
    ldata_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    m_axi_gmem2_WDATA <= ldata_read_reg_127;
