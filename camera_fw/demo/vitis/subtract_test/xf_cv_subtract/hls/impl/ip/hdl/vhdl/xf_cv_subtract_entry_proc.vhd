...
entity xf_cv_subtract_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of xf_cv_subtract_entry_proc is 
...
attribute shreg_extract : string;
    ...
    signal dout_c_write_local : STD_LOGIC;
...
begin
    ...
    dout_c_din <= dout;
    dout_c_write <= dout_c_write_local;

    dout_c_write_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            dout_c_write_local <= ap_const_logic_1;
        else 
            dout_c_write_local <= ap_const_logic_0;
        end if; 
    end process;
