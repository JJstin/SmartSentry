...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "img_out","offset": { "type": "dynamic","port_name": "img_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln1379", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ldata_dout sc_in sc_lv 32 signal 2 } 
	{ ldata_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ ldata_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ ldata_empty_n sc_in sc_logic 1 signal 2 } 
	{ ldata_read sc_out sc_logic 1 signal 2 } 
	...
	{ sext_ln1379 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1379", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1379", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1555203", "Max" : "1555203"}
	, {"Name" : "Interval", "Min" : "1555203", "Max" : "1555203"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1379 { ap_none {  { sext_ln1379 in_data 0 62 } } }
