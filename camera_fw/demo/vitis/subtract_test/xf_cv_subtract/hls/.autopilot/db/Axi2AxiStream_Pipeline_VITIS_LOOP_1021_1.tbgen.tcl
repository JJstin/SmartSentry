...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_in1","offset": { "type": "dynamic","port_name": "img_in1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln1021", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln1021 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1021", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln1021", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln1021 { ap_none {  { sext_ln1021 in_data 0 62 } } }
