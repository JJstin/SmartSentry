...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput2_data_din { O 24 vector } imgInput2_data_num_data_valid { I 3 vector } imgInput2_data_fifo_cap { I 3 vector } imgInput2_data_full_n { I 1 bit } imgInput2_data_write { O 1 bit } } \
} "
}
