...
module xf_cv_subtract_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [20:0] indvar_fu_50;
wire   [20:0] add_ln1021_fu_90_p2;
wire    ap_loop_init;
reg   [20:0] ap_sig_allocacmp_indvar_load;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1021_fu_84_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1021_fu_84_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_load = 21'd0;
    end else begin
...
assign add_ln1021_fu_90_p2 = (ap_sig_allocacmp_indvar_load + 21'd1);
...
assign icmp_ln1021_fu_84_p2 = ((ap_sig_allocacmp_indvar_load == 21'd1555200) ? 1'b1 : 1'b0);

assign ldata_din = gmem0_addr_read_reg_123;
...
endmodule //xf_cv_subtract_Axi2AxiStream_Pipeline_VITIS_LOOP_1021_1
