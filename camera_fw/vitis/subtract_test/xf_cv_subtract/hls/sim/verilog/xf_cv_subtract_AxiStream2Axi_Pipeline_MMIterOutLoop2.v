...
module xf_cv_subtract_AxiStream2Axi_Pipeline_MMIterOutLoop2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] ldata_read_reg_127;
reg    ap_block_pp0_stage0_01001;
reg   [20:0] i_fu_52;
wire   [20:0] add_ln1379_fu_94_p2;
wire    ap_loop_init;
reg   [20:0] ap_sig_allocacmp_i_5;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln1379_fu_88_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1379_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln1379_fu_94_p2 = (ap_sig_allocacmp_i_5 + 21'd1);
...
assign icmp_ln1379_fu_88_p2 = ((ap_sig_allocacmp_i_5 == 21'd1555200) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = ldata_read_reg_127;
...
endmodule //xf_cv_subtract_AxiStream2Axi_Pipeline_MMIterOutLoop2
