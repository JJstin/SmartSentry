...
`define AUTOTB_DUT      xf_cv_subtract
`define AUTOTB_DUT_INST AESL_inst_xf_cv_subtract
`define AUTOTB_TOP      apatb_xf_cv_subtract_top
`define AUTOTB_LAT_RESULT_FILE "xf_cv_subtract.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "xf_cv_subtract.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_xf_cv_subtract_top
...
`define AESL_DEPTH_img_in1 1
`define AESL_DEPTH_img_in2 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvin_gmem1.dat"
`define AUTOTB_TVIN_img_in1_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvin_img_in1.dat"
`define AUTOTB_TVIN_img_in2_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvin_img_in2.dat"
`define AUTOTB_TVIN_img_out_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvin_img_out.dat"
`define AUTOTB_TVOUT_gmem2  "../tv/cdatafile/c.xf_cv_subtract.autotvout_gmem2.dat"
`define AUTOTB_TVOUT_gmem2_out_wrapc  "../tv/rtldatafile/rtl.xf_cv_subtract.autotvout_gmem2.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 4147216;
parameter LENGTH_gmem0 = 1555200;
parameter LENGTH_gmem1 = 1555200;
parameter LENGTH_gmem2 = 1555200;
parameter LENGTH_img_in1 = 1;
parameter LENGTH_img_in2 = 1;
parameter LENGTH_img_out = 1;
...
reg end_img_in1;
reg [31:0] size_img_in1;
reg [31:0] size_img_in1_backup;
reg end_img_in2;
reg [31:0] size_img_in2;
reg [31:0] size_img_in2_backup;
reg end_img_out;
