...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.xf_cv_subtract.autotvin_gmem0.dat"
         "c.xf_cv_subtract.autotvin_gmem1.dat"
         "c.xf_cv_subtract.autotvin_img_in1.dat"
         "c.xf_cv_subtract.autotvin_img_in2.dat"
         "c.xf_cv_subtract.autotvin_img_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.xf_cv_subtract.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
