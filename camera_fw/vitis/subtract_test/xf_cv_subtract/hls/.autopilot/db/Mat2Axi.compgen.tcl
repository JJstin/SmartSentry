...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler xf_cv_subtract_fifo_w64_d3_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {dout_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler xf_cv_subtract_fifo_w32_d2_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler xf_cv_subtract_start_for_AxiStream2Axi_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_AxiStream2Axi_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgOutput_data_dout { I 24 vector } imgOutput_data_empty_n { I 1 bit } imgOutput_data_read { O 1 bit } } \
} "
}
