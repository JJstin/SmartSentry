...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler xf_cv_subtract_fifo_w32_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler xf_cv_subtract_start_for_AxiStream2Mat_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_AxiStream2Mat_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput2_data_din { O 24 vector } imgInput2_data_full_n { I 1 bit } imgInput2_data_write { O 1 bit } } \
} "
}
